        ...
        <ul class="timeline">
            <li>
                ...
                <div class="timeline-panel">
                    ...
                    <div class="timeline-body">
                        <p class="text-muted">Uma grande empresa com uma forte tradição de família decidiu criar um hotel na cidade onde a mesma se encontra, desejando ser reconhecido por ter um excelente atendimento e hospitalidade.</p>
                    </div>
                </div>
            </li>
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    ...
                    <div class="timeline-body">
                        <p class="text-muted">Iniciasse o projeto de construção do hotel, com os melhores engenheiros e materiais do mercado para garantir segurança e longevidade para todos.</p>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="timeline-panel">
                    ...
                    <div class="timeline-body">
                        <p class="text-muted">O hotel finalmente está pronto, com 9 andares e 10 quartos por andar, serviços que incluem café da manhã, piscina, jacuzzi, saunas, WI-FI 5G e muito mais! </p>
                    </div>
                </div>
            </li>
            <li class="timeline-inverted">
