...
<body>
  ...
  <div class="gallery autoplay items-3">
    ...
    <figure class="item ">
      <img src="/assets/img/rooms/P1.png" alt="">
    </figure>

    <figure class="item">
    <img src="/assets/img/rooms/P2.png" alt="">
    </figure>

    <figure class="item">
    <img src="/assets/img/rooms/P3.png" alt="">
    </figure>
    ...
    <div class="container">
        ...
        <div class="col-md-5">
            ...
            <div class="media d-block room mb-0">
                <figure>
                    <img src="\assets\img\portfolio\2.jpg" alt="Generic placeholder image" class="img-fluid">
                ...
                <div class="media-body">
                    <h3 class="mt-0"><a href="#">Quarto Premium</a></h3>
                    <ul class="room-specs">
                        <li><span class="ion-ios-crop"></span> <b> Tamanho do quarto: </b> 30 m <sup>2</sup></li>
                        ...
                        <li><span class="ion-ios-people-outline"></span> 2 camas de casal. </li>
                        <li><span class="ion-ios-people-outline"></span> Comodidades dos quartos: Guarda-roupa, Frigobar, Ar-condicionado, Instalações hipoalergênicas, Micro-ondas, Sofá, Mesa de trabalho, Área de estar, Telefone, Canais via satélite, TV de tela plasma, Canais a cabo e Varanda.</li>
                    </ul>
                    <p> <b>Fumantes: ​Não é permitido fumar.</b> </p>
                    <!-- <p><a href="#" class="btn btn-primary btn-sm">Reserve agora por R$130</a></p> -->
                </div>
            </div>
        </div>
    </div>
